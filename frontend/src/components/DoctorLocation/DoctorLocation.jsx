    ...
    return <div className="home-search-container">
        <div className="location-search-box">
            ...
            <div className="search-location-input-results" hidden={locationResultHidden}>
                {
                    locations.map(location => <div className="search-location-result-item" key={location.place} onClick={handleLocationItemClick} onMouseDown={() => setSearchLocation(location.place)}>
